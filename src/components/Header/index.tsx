        ...
        <>
            <div className={styles.header}>
                <Grid columns={22} gap={8}>
                    ...
                    <Grid.Item span={12}>
                        {showInputMini && <Input placeholder='已收录518个词条' type='text' className={`${styles.search_input}`} />}
                    </Grid.Item>
                    <Grid.Item span={5}>
                ...
                <div className={`${styles.search} flex justify-center`}>
                    {!showInputMini && <Input placeholder='已收录518个词条' type='text' className={`${styles.search_input} search_large`} />}
                </div>
            </div>
        </>
    );
