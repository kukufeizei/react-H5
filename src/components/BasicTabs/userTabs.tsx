...
import type { UserListParams } from '@/api/model/type'
...
const BasicTabs: FC<PropsTypes> = (props) => {
    ...
    const [params, setParams] = useState<UserListParams>({
        ...
        timeline_user_id: userIdParams.s_user_id,
        comment_user_id: userIdParams.s_user_id,
        logged: true,
        prev_id: 0,
        prev_score: '0'
    })
    ...
    const getList = async () => {
        ...
        switch (tabs) {
            case 'mine_question':
                request = userTimelineListApi(params)
                break;
            case 'mine_reply':
                request = userCommentListApi(params)
                break;
        }
